...
namespace Kentico.Components.Web.Mvc.InlineEditors
{
    ...
    /// </summary>
    /// <remarks>
    /// This implementation requires to have a manually registered route that will process the "GetLinkMetadata" request,
    ...
    internal sealed class RichTextInlineEditorUrlRetriever : IRichTextUrlRetriever
    {
        ...
        public string GetLinkMetadataEndpointUrl(UrlHelper urlHelper)
        {
            ...
            return urlHelper.HttpRouteUrl(RichTextInlineEditorConstants.GET_LINK_METADATA_ROUTE_NAME, new RouteValueDictionary());
        }
    }
}
