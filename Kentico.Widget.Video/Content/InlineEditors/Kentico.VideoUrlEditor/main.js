...
var debounce_1 = __importDefault(__webpack_require__(5));
window.kentico.pageBuilder.registerInlineEditor("Kentico.InlineEditor.VideoUrlEditor", {
    init: function (_a) {
        var editor = _a.editor, propertyName = _a.propertyName;
        var input = editor.querySelector("input");
        var errorLabel = editor.querySelector(".ktc-error-label");
        if ((input !== null) && (errorLabel !== null)) {
            ...
            input.addEventListener("input", debounce_1.default(function () {
                // Validate input & invoke property update event
                if (input.reportValidity()) {
                    var event_1 = new CustomEvent("updateProperty", {
                        detail: {
                            value: input.value,
                            name: propertyName
                        }
                    });
                    editor.dispatchEvent(event_1);
                }
            }, 1000));
        }
    },
