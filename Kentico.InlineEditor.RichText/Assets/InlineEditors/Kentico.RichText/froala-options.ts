...
const getDefaultOptions = (editorType: EditorType): Partial<Froala.FroalaOptions> => {
    let options: Partial<Froala.FroalaOptions> = {
        toolbarInline: true,
...
export const getFroalaOptions = (events: Partial<Froala.FroalaEvents>, customOptions: Partial<Froala.FroalaOptions>, editorType: EditorType): Partial<Froala.FroalaOptions> => ({
    ...getDefaultOptions(editorType),
    ...customOptions,
