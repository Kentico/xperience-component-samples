        ...
        public class RichTextEditorTests : UnitTests
        {
            ...
            public void RichTextEditor_PropertyNameIsValidAndLicenseIsEMSAndOnlineMarketingEnabled_WritesToViewContext()
            {
                ...
                Received.InOrder(() =>
                {
                    ...
                    writerMock.Write($"<div class=\"ktc-rich-text-wrapper\" data-context-macros=\"{{&quot;Test&quot;:&quot;TestDisplayName&quot;}}\" data-get-link-metadata-endpoint-url=\"/testApi\" data-rich-text-editor-license=\"{LICENSE_KEY}\" />");
